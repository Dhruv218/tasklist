...
const Newlist = ({ setShowPopup, popupContent, setUpdateUI }) => {
  const [input, setInput] = useState({ toDo: "", Category: "", Priority: "" });
          ...
          <div className="row input-container">
            <div className="select-menu">
              <div className="select" onClick={() => setShowCategoryOptions(!showCategoryOptions)}>
                <span>{input.Category === '' ? 'Select Category' : input.Category}</span>
